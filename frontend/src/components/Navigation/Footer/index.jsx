            ...
            <div className="upper-footer">
                <div className='contact-info'>
                    ...
                    <div className='details'>
                        ...
                        <button className='danger-btn' style={{width:"100px", height:"40px"}}>Sign Up</button>
                    </div>
                    <p>Contact Info</p>
                ...
                <div className='customer-core'>
                    <h3>Customer Core</h3>
                    <p><Link to={"/#My accaunt"}>My accaunt</Link></p>
                    <p><Link to={"/#Discount"}>Discount</Link></p>
                    <p><Link to={"/#Returns"}>Returns</Link></p>
                    <p><Link to={"/#Order History"}>Order History</Link></p>
                    <p><Link to={"/#Order Trackomg"}>Order Trackomg</Link></p>
                </div>
